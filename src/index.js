...
/**
 * 三項演算子
 * 条件句 ? Trueの処理 : Falseの処理
 */
// 例1
const val13 = 1 < 0 ? "trueです" : "falseです";
console.log(val13);

// 例2
const num = 1300; //文字列 or 数値をセットする度に挙動が変わる
const formattedNum =
  typeof num === "number"
    ? num.toLocaleString()
    : "文字列ではなく数値を入力してください";
...
console.log(ret(50, 30));

/**
 * 論理演算子の本当の意味を知ろう
 * || は左側がfalseなら右側を返す
 */
const num14 = null; // null or 100
const fee = num14 || "未設定です";
console.log(fee);
